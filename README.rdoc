...
Once you get a hang for what you can do with Maid, the easiest way is to let Maid do its stuff automatically throughout the day.  You'll find your computer stays a little tidier with as you teach it how to handle your common files.  To do this, edit your crontab in your tool of choice and have it invoke the "maid" command.  A log of the actions taken is kept at ~/.maid/maid.log.
